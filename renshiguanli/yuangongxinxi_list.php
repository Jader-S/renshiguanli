	...
	for($i=$pagecurrent*$pagelarge-$pagelarge;$i<$ddddd;$i++)
{
  ...
  <tr>
    ...
    <td width="120" align="center"><a href="del.php?id=<?php echo mysql_result($query,$i,"id");?>&tablename=yuangongxinxi" onclick="return confirm('真的要删除？')">删除</a> <a href="yuangongxinxi_updt.php?id=<?php echo mysql_result($query,$i,"id");?>">修改</a> <a href="yuangongxinxi_detail.php?id=<?php echo mysql_result($query,$i,"id");?>">详细</a> </td>
  </tr>
  	<?php
	}
}
