		...
		if($rowscount>0)
			...
			else
			{
				...
				$ndate =date("Y-m-d H:i:s");
					...
					$sql="insert into allusers(username,pwd,qx) values('$username','$pwd','$qx')";
					mysql_query($sql); 
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">    <tr>
    ...
    <tr>
      <td>权限:</td>
      <td><input name="qx" type="radio" value="普通管理员" checked="checked" />
      普通管理员
